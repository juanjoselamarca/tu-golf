...
--   3. 4 jugadores fake con scores parciales realistas en la ronda libre
--
...
-- 4 jugadores, scores variados, 12/18 hoyos completos (para mostrar "en vivo")
-- Índices dispersos (5 - 19) para que el leaderboard tenga rango real (scratch, bajo, medio, alto)
...
VALUES
  ('00000000-0000-0000-0000-000000000101'::uuid, '00000000-0000-0000-0000-000000000002'::uuid,
   'Diego Silva', NULL, '00000000-0000-0000-0000-000000000101'::uuid,
  ...
  ('00000000-0000-0000-0000-000000000102'::uuid, '00000000-0000-0000-0000-000000000002'::uuid,
   'Juan Pérez', NULL, '00000000-0000-0000-0000-000000000102'::uuid,
  ...
  ('00000000-0000-0000-0000-000000000103'::uuid, '00000000-0000-0000-0000-000000000002'::uuid,
   'María González', NULL, '00000000-0000-0000-0000-000000000103'::uuid,
...
BEGIN
  ...
  IF v_torneo_count < 1 OR v_ronda_count < 1 OR v_jugadores_count < 4 THEN
