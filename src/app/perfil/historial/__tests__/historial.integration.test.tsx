/**
 * Historial — integración página + hooks reales con supabase SANO mockeado.
...
vi.mock('../hooks/useHistorialStats', () => ({ useHistorialStats: () => null }))
...
// Resultados configurables del mock supabase
