...
export default function DashboardLoading() {
  return (
    <div style={{ background: 'var(--bg-surface)', minHeight: '100vh' }} aria-busy="true" aria-label="Cargando Mi Golf">
      <ShimmerKeyframes />
      ...
      >
        <div style={{ padding: '8px 0 10px', borderBottom: '2px solid var(--brand)' }}><Bar width="92px" height={15} radius={4} /></div>
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        {/* Hero card */}
        <div style={{ border: '1px solid var(--border)', borderRadius: '16px', padding: '20px', marginBottom: '20px' }}>
        ...
        {[0, 1, 2].map((i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 0', borderTop: i === 0 ? 'none' : '1px solid var(--border)' }}>
