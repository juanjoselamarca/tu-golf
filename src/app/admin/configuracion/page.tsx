...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderBottom: '1px solid #132540' }}>
      <span style={{ color: '#94a8c0', fontSize: '0.9rem' }}>{label}</span>
...
function Badge({ text, variant = 'default' }: { text: string; variant?: 'default' | 'gold' }) {
  ...
  const color = variant === 'gold' ? '#050b14' : '#94a8c0'
  return (
    <span
      style={{
    ...
    <div style={{ padding: '32px', maxWidth: 1200, margin: '0 auto' }}>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <div style={card}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0' }}>
            <span style={{ color: '#94a8c0', fontSize: '0.9rem' }}>Stack</span>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <div style={card}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0' }}>
            <span style={{ color: '#94a8c0', fontSize: '0.9rem' }}>Estado</span>
            <span style={{ color: '#edeae4', fontSize: '0.9rem' }}>
      ...
      <section>
        ...
        <div style={card}>
          ...
          <p style={{ color: '#94a8c0', fontSize: '0.85rem', marginTop: '12px' }}>
