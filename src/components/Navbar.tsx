  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {user ? (
              ...
              <>
                ...
                <Link href="/register"
                  ...
                  style={{ background: '#c4992a', color: '#070d18', borderRadius: '8px', fontSize: '14px', textDecoration: 'none' }}>
                  Registrarse
                </Link>
              </>
            )}
        ...
        {/* Mobile menu */}
        {menuOpen && (
          <div className="md:hidden py-5 flex flex-col gap-4" style={{ borderTop: '1px solid rgba(196,153,42,0.2)' }}>
            ...
            <div className="pt-3 flex flex-col gap-3" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
              {user ? (
                <>
                  ...
                  <Link href="/perfil" className="text-ivory/70 hover:text-ivory text-sm font-medium font-sans" onClick={() => setMenuOpen(false)}>Mi Perfil</Link>
                  <Link href="/torneo/tpc-sawgrass-amateur-2025"
