...
export const NAV_THEME_LIGHT: NavTheme = {
  ...
  sectionLabel: '#6B7280',
  itemText: '#1a1a2e',
  itemActive: '#8A6A16', /* WCAG AA: gold accesible (5:1) sobre superficies blancas */
  itemActiveBg: 'rgba(196,153,42,0.12)',
  bottomNavBg: 'rgba(255,255,255,0.95)',
  bottomNavBorder: '#e2e8f0',
  loginBtnBorder: 'rgba(196,153,42,0.55)',
  loginBtnText: '#8A6A16', /* WCAG AA: 5:1 sobre #fff */
  guestBtnBg: 'transparent',
  guestBtnText: '#1a1a2e',
