...
export function EmptyState({ icon, title, description, actionLabel, onAction, actionHref }: EmptyStateProps) {
  return (
    <div style={{ textAlign: 'center', padding: '40px 20px' }}>
      ...
      <h3 style={{ fontFamily: '"Playfair Display", serif', color: 'var(--text)', marginBottom: '8px', fontSize: '18px' }}>
        {title}
      </h3>
      <p style={{ color: 'var(--text-2)', marginBottom: '20px', fontSize: '14px' }}>{description}</p>
