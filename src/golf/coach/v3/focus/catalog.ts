...
export const FOCUS_CATALOG: FocusCandidate[] = [
  {
    ...
    accion:
      'Hacé un reset de 4 pasos después de cada bogey: soltá el hoyo, respirá, visualizá el próximo tiro y comprometete. El hoyo anterior no existe.',
    minConfidence: 0.5,
    minSample: 3,
  ...
  },
  {
    ...
    accion: 'Cuidá la energía: hidratate, comé algo en el hoyo 10 y hacé un reset mental antes de arrancar el back nine.',
    minConfidence: 0.5,
    minSample: 3,
  ...
  },
  {
    ...
    accion: 'Antes del primer tee, anclate en quién sos como jugador y definí un plan claro para ese tiro. El hoyo 1 no define tu ronda.',
    minConfidence: 0.4,
    minSample: 3,
