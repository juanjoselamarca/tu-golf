...
export const FOCUS_CATALOG: FocusCandidate[] = [
  {
    ...
    accion:
      'reset_4_pasos obligatorio después de cada bogey. next_shot_mentality — el hoyo anterior no existe.',
    minConfidence: 0.5,
    minSample: 3,
  ...
  },
  {
    ...
    accion: 'Gestión de energía: hidratación, snack en hoyo 10, reset_4_pasos antes del back nine.',
    minConfidence: 0.5,
    minSample: 3,
  ...
  },
  {
    ...
    accion: 'Rutina pre-ronda: 15 min putting green + breathing_4_4_6 antes del primer tee.',
    minConfidence: 0.5,
    minSample: 3,
    measure: ({ rounds }) => aggregate(rounds, computeBack9MinusFront9),
  },
  {
    ...
    accion: 'identity_anchor + think_box antes del primer tee. El hoyo 1 no define tu ronda.',
    minConfidence: 0.4,
    minSample: 3,
