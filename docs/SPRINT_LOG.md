...
- **124:** tabla detalle match play con `tableLayout: fixed` + colgroup (anchos
  estables) y sin el "P4/P3" pegado al hoyo.
- **126 (feature):** expand de tarjeta de equipo en best ball (Scorecard estándar por
  miembro). `TeamLeaderboard` compartido con expand **opt-in** → los otros 7 call sites
  intactos.
- **Calidad:** tsc 0 · 2752 tests · build OK · `superpowers:code-reviewer` PASS (0
  P0/P1, 2 P2 aplicados). 4 reportes de inbox marcados `resuelto`.
